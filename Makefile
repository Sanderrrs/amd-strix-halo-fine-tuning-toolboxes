...
.PHONY: help install-packages theRock pytorch bitsandbytes flash-attn rocWMMA llama-cpp unsloth
...
theRock: install-packages ## Installs ROCm in /opt/rocm from theRock Nightly
