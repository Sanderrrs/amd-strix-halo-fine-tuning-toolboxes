...
ASCII
echo
printf 'AMD STRIX HALO — Fine Tuning Toolbox (gfx1151, ROCm via TheRock)\n'
[[ -n "$ROCM_VER" ]] && printf 'ROCm nightly: %s\n' "$ROCM_VER"
echo
printf 'Machine: %s\n' "$MACHINE"
printf 'GPU    : %s\n\n' "$GPU"
printf 'Repo   : https://github.com/shantur/amd-strix-halo-fine-tuning-toolboxes\n'
printf 'Image  : docker.io/shantur/amd-strix-halo-fine-tuning-toolboxes\n\n'
echo
printf 'Original Idea : https://github.com/kyuz0/amd-strix-halo-image-video-toolboxes\n'
echo
